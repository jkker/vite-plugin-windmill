...
Current release line: `1.704.x`

It currently depends on `windmill-client@^1.704.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.704.0`.
