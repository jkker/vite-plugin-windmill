...
Current release line: `1.709.x`

It currently depends on `windmill-client@^1.709.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.709.0`.
