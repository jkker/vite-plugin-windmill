...
Current release line: `1.740.x`

It currently depends on `windmill-client@^1.740.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.740.0`.
