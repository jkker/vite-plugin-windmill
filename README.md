...
Current release line: `1.801.x`

It currently depends on `windmill-client@^1.801.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.801.0`.
