...
Current release line: `1.775.x`

It currently depends on `windmill-client@^1.775.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.775.1`.
