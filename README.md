...
Current release line: `1.770.x`

It currently depends on `windmill-client@^1.770.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.770.0`.
