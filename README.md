...
Current release line: `1.776.x`

It currently depends on `windmill-client@^1.776.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.776.0`.
