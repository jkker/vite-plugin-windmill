...
Current release line: `1.682.x`

It currently depends on `windmill-client@^1.682.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.682.0`.
