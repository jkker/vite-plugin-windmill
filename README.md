...
Current release line: `1.742.x`

It currently depends on `windmill-client@^1.742.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.742.0`.
