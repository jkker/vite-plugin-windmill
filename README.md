...
Current release line: `1.792.x`

It currently depends on `windmill-client@^1.792.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.792.1`.
