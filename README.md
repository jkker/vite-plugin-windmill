...
Current release line: `1.745.x`

It currently depends on `windmill-client@^1.745.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.745.0`.
