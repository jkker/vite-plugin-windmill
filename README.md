...
Current release line: `1.755.x`

It currently depends on `windmill-client@^1.755.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.755.0`.
