...
Current release line: `1.735.x`

It currently depends on `windmill-client@^1.735.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.735.0`.
