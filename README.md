...
Current release line: `1.741.x`

It currently depends on `windmill-client@^1.741.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.741.0`.
