...
Current release line: `1.791.x`

It currently depends on `windmill-client@^1.791.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.791.0`.
