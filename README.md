...
Current release line: `1.706.x`

It currently depends on `windmill-client@^1.706.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.706.0`.
