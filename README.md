...
Current release line: `1.730.x`

It currently depends on `windmill-client@^1.730.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.730.0`.
