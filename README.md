...
Current release line: `1.734.x`

It currently depends on `windmill-client@^1.734.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.734.0`.
