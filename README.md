...
Current release line: `1.812.x`

It currently depends on `windmill-client@^1.812.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.812.0`.
