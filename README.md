...
Current release line: `1.694.x`

It currently depends on `windmill-client@^1.694.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.694.0`.
