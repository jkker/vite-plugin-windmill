...
Current release line: `1.817.x`

It currently depends on `windmill-client@^1.817.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.817.0`.
