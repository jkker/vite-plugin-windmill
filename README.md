...
Current release line: `1.718.x`

It currently depends on `windmill-client@^1.718.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.718.0`.
