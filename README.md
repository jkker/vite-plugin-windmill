...
Current release line: `1.765.x`

It currently depends on `windmill-client@^1.765.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.765.0`.
