...
Current release line: `1.738.x`

It currently depends on `windmill-client@^1.738.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.738.0`.
