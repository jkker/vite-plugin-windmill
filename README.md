...
Current release line: `1.786.x`

It currently depends on `windmill-client@^1.786.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.786.0`.
