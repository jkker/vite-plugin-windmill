...
Current release line: `1.701.x`

It currently depends on `windmill-client@^1.701.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.701.0`.
