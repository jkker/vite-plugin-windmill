...
Current release line: `1.780.x`

It currently depends on `windmill-client@^1.780.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.780.0`.
