...
Current release line: `1.696.x`

It currently depends on `windmill-client@^1.696.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.696.0`.
