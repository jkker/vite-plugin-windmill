...
Current release line: `1.756.x`

It currently depends on `windmill-client@^1.756.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.756.0`.
