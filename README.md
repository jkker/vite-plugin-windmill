...
Current release line: `1.716.x`

It currently depends on `windmill-client@^1.716.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.716.0`.
