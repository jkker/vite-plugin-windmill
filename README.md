...
Current release line: `1.723.x`

It currently depends on `windmill-client@^1.723.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.723.0`.
