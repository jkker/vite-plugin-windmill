...
Current release line: `1.717.x`

It currently depends on `windmill-client@^1.717.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.717.1`.
