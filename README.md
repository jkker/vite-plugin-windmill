...
Current release line: `1.764.x`

It currently depends on `windmill-client@^1.764.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.764.0`.
