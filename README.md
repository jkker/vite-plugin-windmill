...
Current release line: `1.697.x`

It currently depends on `windmill-client@^1.697.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.697.0`.
