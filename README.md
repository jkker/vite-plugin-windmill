...
Current release line: `1.719.x`

It currently depends on `windmill-client@^1.719.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.719.0`.
