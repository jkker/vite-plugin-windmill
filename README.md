...
Current release line: `1.767.x`

It currently depends on `windmill-client@^1.767.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.767.0`.
