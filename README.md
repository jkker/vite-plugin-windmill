...
Current release line: `1.763.x`

It currently depends on `windmill-client@^1.763.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.763.0`.
