...
Current release line: `1.816.x`

It currently depends on `windmill-client@^1.816.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.816.0`.
