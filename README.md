...
Current release line: `1.771.x`

It currently depends on `windmill-client@^1.771.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.771.1`.
