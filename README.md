...
Current release line: `1.721.x`

It currently depends on `windmill-client@^1.721.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.721.0`.
