...
Current release line: `1.692.x`

It currently depends on `windmill-client@^1.692.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.692.0`.
