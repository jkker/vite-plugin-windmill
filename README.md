...
Current release line: `1.811.x`

It currently depends on `windmill-client@^1.811.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.811.0`.
