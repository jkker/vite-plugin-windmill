...
Current release line: `1.805.x`

It currently depends on `windmill-client@^1.805.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.805.0`.
