...
Current release line: `1.705.x`

It currently depends on `windmill-client@^1.705.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.705.0`.
