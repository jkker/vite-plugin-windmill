...
Current release line: `1.711.x`

It currently depends on `windmill-client@^1.711.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.711.0`.
