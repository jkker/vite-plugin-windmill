...
Current release line: `1.800.x`

It currently depends on `windmill-client@^1.800.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.800.0`.
