...
Current release line: `1.747.x`

It currently depends on `windmill-client@^1.747.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.747.0`.
