...
Current release line: `1.712.x`

It currently depends on `windmill-client@^1.712.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.712.0`.
