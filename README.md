...
Current release line: `1.685.x`

It currently depends on `windmill-client@^1.685.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.685.0`.
