...
Current release line: `1.688.x`

It currently depends on `windmill-client@^1.688.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.688.0`.
