...
Current release line: `1.695.x`

It currently depends on `windmill-client@^1.695.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.695.0`.
