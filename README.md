...
Current release line: `1.783.x`

It currently depends on `windmill-client@^1.783.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.783.0`.
