...
Current release line: `1.794.x`

It currently depends on `windmill-client@^1.794.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.794.1`.
