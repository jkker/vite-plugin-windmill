...
Current release line: `1.728.x`

It currently depends on `windmill-client@^1.728.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.728.0`.
