...
Current release line: `1.788.x`

It currently depends on `windmill-client@^1.788.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.788.0`.
