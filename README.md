...
Current release line: `1.804.x`

It currently depends on `windmill-client@^1.804.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.804.0`.
