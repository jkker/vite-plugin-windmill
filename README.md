...
Current release line: `1.754.x`

It currently depends on `windmill-client@^1.754.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.754.0`.
