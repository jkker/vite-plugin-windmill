...
Current release line: `1.686.x`

It currently depends on `windmill-client@^1.686.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.686.0`.
