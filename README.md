...
Current release line: `1.739.x`

It currently depends on `windmill-client@^1.739.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.739.0`.
