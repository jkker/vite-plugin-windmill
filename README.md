...
Current release line: `1.743.x`

It currently depends on `windmill-client@^1.743.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.743.0`.
