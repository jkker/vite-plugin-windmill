...
Current release line: `1.784.x`

It currently depends on `windmill-client@^1.784.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.784.0`.
