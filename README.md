...
Current release line: `1.689.x`

It currently depends on `windmill-client@^1.689.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.689.0`.
