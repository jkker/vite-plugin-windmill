...
Current release line: `1.815.x`

It currently depends on `windmill-client@^1.815.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.815.0`.
