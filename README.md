...
Current release line: `1.713.x`

It currently depends on `windmill-client@^1.713.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.713.0`.
