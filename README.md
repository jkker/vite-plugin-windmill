...
Current release line: `1.760.x`

It currently depends on `windmill-client@^1.760.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.760.1`.
