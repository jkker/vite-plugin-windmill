...
Current release line: `1.810.x`

It currently depends on `windmill-client@^1.810.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.810.0`.
