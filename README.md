...
Current release line: `1.773.x`

It currently depends on `windmill-client@^1.773.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.773.0`.
