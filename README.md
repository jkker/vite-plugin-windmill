...
Current release line: `1.708.x`

It currently depends on `windmill-client@^1.708.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.708.0`.
