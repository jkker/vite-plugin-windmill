...
Current release line: `1.795.x`

It currently depends on `windmill-client@^1.795.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.795.0`.
