...
Current release line: `1.746.x`

It currently depends on `windmill-client@^1.746.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.746.0`.
