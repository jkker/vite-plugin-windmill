...
Current release line: `1.796.x`

It currently depends on `windmill-client@^1.796.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.796.0`.
