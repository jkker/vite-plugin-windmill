...
Current release line: `1.806.x`

It currently depends on `windmill-client@^1.806.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.806.0`.
