...
Current release line: `1.700.x`

It currently depends on `windmill-client@^1.700.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.700.1`.
