...
Current release line: `1.720.x`

It currently depends on `windmill-client@^1.720.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.720.0`.
