...
Current release line: `1.687.x`

It currently depends on `windmill-client@^1.687.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.687.0`.
