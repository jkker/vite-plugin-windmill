...
Current release line: `1.726.x`

It currently depends on `windmill-client@^1.726.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.726.1`.
