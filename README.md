...
Current release line: `1.777.x`

It currently depends on `windmill-client@^1.777.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.777.1`.
