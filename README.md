...
Current release line: `1.707.x`

It currently depends on `windmill-client@^1.707.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.707.0`.
