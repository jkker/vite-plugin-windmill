...
Current release line: `1.762.x`

It currently depends on `windmill-client@^1.762.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.762.1`.
