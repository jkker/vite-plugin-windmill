...
Current release line: `1.793.x`

It currently depends on `windmill-client@^1.793.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.793.0`.
