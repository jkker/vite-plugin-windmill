...
Current release line: `1.790.x`

It currently depends on `windmill-client@^1.790.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.790.0`.
