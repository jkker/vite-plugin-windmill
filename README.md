...
Current release line: `1.818.x`

It currently depends on `windmill-client@^1.818.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.818.0`.
