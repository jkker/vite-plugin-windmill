...
Current release line: `1.789.x`

It currently depends on `windmill-client@^1.789.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.789.0`.
