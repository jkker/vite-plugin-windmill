...
Current release line: `1.808.x`

It currently depends on `windmill-client@^1.808.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.808.0`.
