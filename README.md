...
Current release line: `1.699.x`

It currently depends on `windmill-client@^1.699.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.699.0`.
