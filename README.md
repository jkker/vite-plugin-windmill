...
Current release line: `1.753.x`

It currently depends on `windmill-client@^1.753.0` and bundles `rawAppWmillTs.ts` generated from `windmill-labs/windmill@v1.753.0`.
